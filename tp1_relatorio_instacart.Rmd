...
# Define data frame
df_1 <- tibble(Atributo = c("oder_id", "product_id", "add_to_cart_order", "reordered"),
               `Número de Observações Faltantes` = rep(0, 4))
...
# Draw table
kable(order_products_train %>%  slice(1:10))
...
* [\textcolor{blue}{Learn by Merketing}](https://www.learnbymarketing.com/1043/working-with-arules-transactions-and-read-transactions/)
